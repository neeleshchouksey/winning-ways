(function($) {
    ...
    $(document).ready(function ($) {
        ...
        $("#deal-coupon-slider").owlCarousel({
            ...
            nav: true,
            autoPlay: 8000,
            navText: ["<div class='lnr lnr-chevron-left'></div>", "<div class='lnr lnr-chevron-right'></div>"],
        ...
        $("#new-deal-carousel").owlCarousel({
            ...
            nav: true,
            autoPlay: 3000,
            navText: ["<div class='lnr lnr-arrow-left new-lnr-left'></div>", "<div class='lnr lnr-arrow-right new-lnr-right'></div>"],
            responsiveClass:true,
            responsive: {
                0:{
                    items:2
